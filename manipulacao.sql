...
/*insert into funcionarios (id_funcionario, nome, cpf, data_nascimento, endereco, telefone, email, cargo, salario, data_admissao)
values 
...
/*update funcionarios set cargo = 'Garçonete',
salario = 2700.00 where id_funcionario = 4;*/
